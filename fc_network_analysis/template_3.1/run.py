'''Connected to supervised_fc_nn template 1.
...
from supervised_fc_nn.template_1.run import DiffusionNet
...
class FCNetworkAnalysisPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('fc_network_analysis', 'template_3.1', 'experiments', 
...
def main():
    ...
    parser.add_argument('--supervised_fc_nn_paths_pkl', type=str, required=True)
    ...
    model: DiffusionNet = torch.load(supervised_fc_nn_paths.best_model_file).to(device)
