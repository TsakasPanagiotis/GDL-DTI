...
from fc_network.template_1.run import Hyperparameters, DiffusionDataset, SpectralDiffusionNet


@dataclass
class Paths:
    experiments_dir = os.path.join('analysis', 'template_1', 'experiments')
