'''Connected to supervised_fc_nn template 2.
...
from supervised_fc_nn.template_2.run import (
    DiffusionNet,
    get_selection_mask
)
...
class FCNetworkAnalysisPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('fc_network_analysis', 'template_5', 'experiments', 
