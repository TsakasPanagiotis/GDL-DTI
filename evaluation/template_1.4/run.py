...
class EvaluationPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('evaluation', 'template_1.4', 'experiments', 
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(evaluation_paths.eigenvalues_parity_plot_file)
    ...
    plt.tight_layout()
    plt.savefig(evaluation_paths.eigenvectors_histogram_plot_file)
    ...
    plt.tight_layout()
    plt.savefig(evaluation_paths.eigenvalues_bland_altman_plot_file)
    ...
    plt.tight_layout()
    plt.savefig(evaluation_paths.mean_diffusivity_bland_altman_plot_file)
    ...
    plt.tight_layout()
    plt.savefig(evaluation_paths.fractional_anisotropy_bland_altman_plot_file)
