...
def main() -> None:
    ...
    if resume_args.resume_experiment_name:
        ...
        main_parser.add_argument('--d_tensors_file', type=str, required=True)
        main_parser.add_argument('--noisy_signals_file', type=str, required=True)
    ...
    d_tensors = torch.load(HP.d_tensors_file)
    noisy_signals = torch.load(HP.noisy_signals_file)
