...
class GroundTruthPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('ground_truth', 'template_8.1', 'experiments', 
...
def reconstruct(params: np.ndarray) -> tuple[np.ndarray, float]:
    ...
    lower_triangular[0,0] = d_params[0]
    lower_triangular[1,0] = d_params[1]
    lower_triangular[1,1] = d_params[2]
    lower_triangular[2,0] = d_params[3]
    lower_triangular[2,1] = d_params[4]
    lower_triangular[2,2] = d_params[5]
