'''Connected to equivariant_nn_2 template 1_2.
...
from equivariant_nn_2.template_1_2.run import (
    get_selection_masks,
    SignalsDataset,
    SignalToIrreps,
    DiffusionDataset,
...
class EquivariantNNAnalysisPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('equivariant_nn_analysis_2', 'template_1_3', 'experiments', 
