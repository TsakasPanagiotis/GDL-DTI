'''Connected to fc_network_2 template 3.
...
from fc_network_2.template_3.run import (
    get_selection_mask,
    DiffusionDataset,
    DiffusionNet,
    reconstruct
...
class FCNetworkAnalysisPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('fc_network_analysis_2', 'template_3', 'experiments', 
