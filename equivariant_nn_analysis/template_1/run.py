'''Connected to equivariant_nn template 1.
...
from equivariant_nn.template_1.run import (
    SignalToIrreps,
    SignalsDataset,
    DiffusionDataset,
    EquivariantNet,
...
class EquivariantNNAnalysisPaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('equivariant_nn_analysis', 'template_1', 'experiments', 
