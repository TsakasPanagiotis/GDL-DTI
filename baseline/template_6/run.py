'''Based on ground truth template 9.
Load simulated data.
...
class BaselinePaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('baseline', 'template_6', 'experiments', 
...
def reconstruct(params: np.ndarray, threshold_eigval: float) \
    ...
    z_angle_y = z_angle_y / norm_z

    x_angle = np.arctan2(x_angle_y, x_angle_x)
