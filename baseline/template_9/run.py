'''Based on ground truth template 11.
Load simulated data.
...
class BaselinePaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('baseline', 'template_9', 'experiments', 
...
def reconstruct(params: np.ndarray, threshold_eigval: float) \
    ...
    a, b, c, d, eigval_1, eigval_2_over_1, eigval_3_over_2 = params[:7]
