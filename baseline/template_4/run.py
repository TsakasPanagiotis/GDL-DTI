'''Based on ground truth template 6.2.
Load simulated data.
...
class BaselinePaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('baseline', 'template_4', 'experiments', 
...
def main():
    ...
    max_bounds = [2*np.pi, np.pi, 2*np.pi, baseline_hparams.threshold_eigval, 1, 1]
