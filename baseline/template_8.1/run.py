...
class BaselinePaths:
    def __init__(self) -> None:
        self.experiment_path = os.path.join('baseline', 'template_8.1', 'experiments', 
...
def main():
    ...
    test_data = get_noisy_signals(test_indices, baseline_hparams.snr, d_tensors, b_values, b_vectors)
